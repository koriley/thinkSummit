                ...
                <div class="row">
                    <div class="agendaMother">
                        ...
                        <div class="agendaEvent">
                            ...
                            <div class="agendaDesc inline">
                                <div class="eventTitle">There's no place like home, especially when it's protected by Atlas Security. Get cozy on a couch and talk with the team from Atlas-all without missing a single moment of the big event, because it'll be coming at you via
                                    live feed.</div>
                            </div>
                        </div>
                        ...
                        <div class="agendaEvent">
                            ...
                            <div class="agendaDesc inline">
                                <div class="eventTitle">Brought to you by OTC Workforce Development and Essential Strategies, this area is the hot spot to meet and greet with our speakers. This is what today&rsquo;s all about: starting a conversation about how we can take what
                                    we learn today and move our region forward.</div>
                            </div>
                        </div>
                        <div class="agendaEvent">
                            <div class="agendaMarker inline">&nbsp;</div>
                            ...
                            <div class="agendaDesc inline">
                                <div class="eventTitle">We know you&rsquo;re busy. Take your time to reply to emails or catch a conference call without missing out on what&rsquo;s happening in the People Centric Think Tank. We&rsquo;re simulcasting the event here in partnership
                                    with MSU College of Business.</div>
                            </div>
                        </div>
                        <div class="agendaEvent">
                            <div class="agendaMarker inline">&nbsp;</div>
                        ...
                        <div class="agendaEvent">
                            ...
                            <div class="agendaDesc inline">
                                <div class="eventTitle">Engage with the conversation, and see your tweets on the big screen at the #417ThinkSummit Social Wall. We&rsquo;re live tweeting the event and sharing photos all day long. So set your social to public and include the hashtag
            ...
            <div class="container">
                ...
                <div class="speakerProfiles" style=" ">
                    <? //start speakers ?>
                        ...
                        <div class="speaker">
                            <div class="img"><img alt="" src="img/speakerheadshots/Houghton.png" />
                                <div class="speakerName">
                                    <div class="innerText">
                                        <div class="theSpeakerName">JEFF &amp; MICHELLE HOUGHTON</div>
                                        <div class="speakerCompany">The Mystery Hour</div>
                                        <div class="speakerDesc">Turn your dream into your vocation</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="presentedBy" style="text-align: center;">
                            ...
                            <div class="presentedByImg inline">
                                <a href="https://www.peopleccg.com/" target="_blank"><img src="img/sponsor_logos/peoplecentricBlack.png" /></a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="sponsors" style="text-align: center;">
                            ...
                            <div class="sponsorsNormal inline">
                                <div class="sponsorText inline">SPONSORED BY</div><br/>
                                <div class="sponsorFlex">
                                    <div class="sponsorImg inline">
                                        <a href="https://business.missouristate.edu/" target="_blank"><img src="img/sponsor_logos/MSUblack.png" /></a>
                                    </div>
                                    <div class="sponsorImg inline">
                                        <a href="http://www.groomsinc.com/" target="_blank"><img src="img/sponsor_logos/groomsBlack.png" /></a>
                                    </div>
                                    <div class="sponsorImg inline">
                                        <a href="http://one.paperwise.com/" target="_blank"><img src="img/sponsor_logos/paperwiseBlack.png" /></a>
                                    </div>
                                    <div class="sponsorImg inline">
                                        <a href="http://atlassecurity.com/" target="_blank"><img src="img/sponsor_logos/atlasBlack.png" /></a>
                                    </div>
                                    <div class="sponsorImg inline">
                                        <a href="http://www.esstrat.com/contact-us.html" target="_blank"><img src="img/sponsor_logos/essentialstrategiesBlack.png" /></a>
                                    </div>
                                    <div class="sponsorImg inline">
                                        <a href="https://workforce.otc.edu/" target="_blank"><img src="img/sponsor_logos/OTCblack.png" /></a>
                                    </div>
                                </div>
                            </div>

                            <div class="sponsorsHosted inline">
                                <div class="hostedText inline">HOSTED BY</div><br/>
                                <div class="sponsorFlex">
                                    <div class="hostedImg inline sponsorImg">
                                        <a href="http://www.sgfmuseum.org/" target="_blank"><img src="img/sponsor_logos/artmuseumBlack.png" /></a>
                                    </div>
                                </div>
                            </div>
                            <div class="sponsorsHosted inline">
                                ...
                                <div class="sponsorFlex">
                                    <div class="hostedImg inline sponsorImg">
                                        <a href="http://simplydeliciousllc.com/" target="_blank"><img src="img/sponsor_logos/simplydeliciousBlack.png" /></a>
                                    </div>
                                    <div class="hostedImg inline sponsorImg">
                                        <a href="http://www.mothersbrewing.com/" target="_blank"><img src="img/sponsor_logos/mothersBlack.png" /></a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        This will open a new browser window to 417tix.com where you can purchase Think Summit tickets. This app will be running in the background so you can get back quickly.
                    </div>
                    <div class="modal-footer">
                        <a href="https://417tix.com/events/biz-417-s-think-summit-presented-by-people-centric-consulting-group" type="button" class="btn priButton" target="_blank">Take me to 417tix.com</a>
